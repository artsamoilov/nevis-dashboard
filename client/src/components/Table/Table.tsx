...
export const Table = ({data, months}: TableProps) => {
    ...
    return (
        <S.ScrollContainer>
            <S.TableWrapper $columns={months.length} role="table" aria-label="Clients by month">
                ...
                <S.RowGroup role="rowgroup">
                    <TableRowTree node={data} depth={0} expandedIds={expandedIds} onToggleExpand={handleToggleExpand} />
                </S.RowGroup>
            </S.TableWrapper>
        </S.ScrollContainer>
    )
